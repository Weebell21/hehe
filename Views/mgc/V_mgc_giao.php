...
<div class="container mt-4" >
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                <h5 class="card-title">Nhập Giao Hàng</h5>
                <form action="../../Controllers/MGC/Giao/C_MGC_In.php" method="post">
                    <div class="row">
                        <div class=" mb-my-4">
                        ...
                        <div class=" mb-my-4">
                            <label for="input1" class="form-label">Nhà May</label>
                            <input type="text" class="form-control" id="nhamay" name="nhamay" required>
                        </div>
                        <div class=" mb-my-4">
                        ...
                        <div class="row">
                            <div class="col mb-my-4 flex">
                                <label for="input4" class="form-label">Màu</label>
                        ...
                        <div class="col mb-my-4 flex">
                                <label for="input5" class="form-label">Tổng Số lượng</label>
                                <input type="text" class="form-control" id="total" name="total" required>
                        </div>
                        <div class="mb-my-4">
                            <label for="input3" class="form-label">Tình Trạng</label>
                            <select type="text" class="form-control" id="stat" name="stat" required>
                                <option></option>
